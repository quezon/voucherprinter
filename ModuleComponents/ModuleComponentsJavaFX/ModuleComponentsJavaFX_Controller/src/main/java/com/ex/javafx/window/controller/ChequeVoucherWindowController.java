...
public class ChequeVoucherWindowController implements Initializable {
	...
	// cheques
	@FXML
	private ChoiceBox<String> chequeBankName;
	@FXML
	private TextField chequeNumber;
	@FXML
	private TextField chequeRoutingNumber;
	@FXML
	private TextField chequeAccountNumber;
	@FXML
	private TextField chequeAmountCheque;
	// voucher
	// main voucher info
	@FXML
...
//				.addListener(new AmountChangeListener(totalPayments, amountPayment, "\\d{0,7}([\\.]\\d{0,2})?"));
	...
	public void addCheque(MouseEvent event) {

	}

	public void removeCheque(MouseEvent event) {

	}

	public void editCheque(MouseEvent event) {
